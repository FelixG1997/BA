...
Als weitere Verbesserung kann direkt beim Erstellen des Permutationsbaum bei eines der Abbruchbedingungen der Baum an der Stelle abgeschnitten werden. Somit werden viele Permutationen gar nicht erst erstellt und die Gesamtlaufzeit verbessert sich erheblich. Allerdings wird hierbei der Brute-Force-Ansatz nur zur Bestimmung der Güte verwendet und muss keine guten Laufzeiten erzielen.\\
\textcolor{red}{TODO: Bei sehr viel Zeit den genauen Algorithmus aufschreiben und Laufzeit abschätzen, ggf. könnte dieser Ansatz sogar für $n\approx 15$ im worst-case keine gravierenden Laufzeiten erzeugen.}\\
...
Nach verschiedenen worse-case-Analysen hat sich schlussendlich gezeigt, dass die Erstellung des Permutationsbaums mit Abstand die größte Laufzeit einbüßt. Somit hat der Brute-Force-Algorithmus eine Zeitkomplexität von $\mathcal{O}(n!)$. 
...
\chapter{Experimente}
\textcolor{red}{TODO}
Meine Vorschläge für dieses Kapitel:
\begin{itemize}
\item
1D für $n=10,100,1000,10000$ testen, dabei eine Laufzeitkurve erstellen und analysieren
\item
$1.000.000$ mal den 2OA- gegen den Brute-Force-Algorithmus laufen lassen. Mit den Tourzeiten die Güte des 2OA-Algorithmus bestimmen.
\item
2OA-Algorithmus in allen Kombinationen der folgenden Parametern testen:
\begin{align*}
n&=5,25,50,75,100\\
(v_{verfolger},v_i)&=(20,200),(40,100),(60,59)\\
Startpositionen&=[10.000]
\end{align*}
Die zweite Notation Bedeutet dabei, dass die Verfolgergeschwindigkeit für $20,40,60$ und die Zielgeschwindigkeit (fest gesetzt für alle Ziele) für $200,100,59$ getestet wird(Parameterwahl nach \cite{stieber2015multiple} orientiert).
\end{itemize} 
