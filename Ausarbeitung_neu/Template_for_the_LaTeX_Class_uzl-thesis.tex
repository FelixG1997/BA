...
Der eindimensionale Algorithmus (siehe Algorithmus \ref{alg:1D}) findet optimale Lösungen innerhalb von $\mathcal{O}(n^2)$. Dabei ist interessant, wie sich die Laufzeit bei verschiedenen Instanzen im Durchschnitt verhält. Es werden nun folgende Parameter festgesetzt:
\begin{align*}
...
\section{Instanzen mit $n\leq 100$ Zielen für den Prioritäts-Algorithmus}
