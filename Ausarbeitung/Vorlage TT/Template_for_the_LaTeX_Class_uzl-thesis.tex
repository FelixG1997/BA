...
\begin{Latex}
\documentclass[german, version-2019-07]{uzl-thesis}
\end{Latex}
%
or with
%
...
You \emph{must} also provide the class version key\footnote{In
  computer science parlor, a “key” is a text like \Latex{version-2019-07}
...
the same \textsc{pdf} as it did in 2019. Just leave this class version
key as it is. 
...
\item[computer modern basic design]
  ...
  installed. This font is the university's official font, which is why it
  appropriate for the title page. However, the font does not otherwise
...
\item[Datum] The date you turn in your thesis. Do \emph{not} be
  ...
  first of June 2019 must be formatted as “1. Juni 2019“. Do
  \emph{not} write any of “01. Juni 2019” or “01. 06. 2019“ or
  “1.6.2019” or “1. 6. 2019” or “2019-06-01”.
...
The main part of your thesis consists of \emph{chapters}\footnote{In a
  German thesis, use the word “\foreignlanguage{german}{Kapitel}” to refer to a section.} (using
...
them. Also, do not even think of using |\subsubsection|.
...
and consider them perfectly superfluous. I guess they are mainly
...
The thesis class does not generate lists of figures or tables and
actually hacks into \LaTeX's internals in a way that makes it
difficult to create such lists. Do not try to create any. 
...
picture. Here is an example how you will usually do this:
...
either explicitly use or that are generally setup. For instance, the
...
\tikz [baseline, anchor=base] \node [block] {Hello};.
\item[small block] A small rectangular node: Saying
|\tikz \node [small block] {Hello};|
  yields
\tikz [baseline, anchor=base] \node [small block] {Hello};.
\item[node] A circular node, especially in a graph: |\tikz \node [node] {$n$};|
  yields
\smash{\tikz [baseline, anchor=base] \node [node] {$n$};}.
...
\item[thesis flat shapes] This style redefines |base shape| in a quite
  different manner: The shapes are only filled and no border is
...
you have to grade a \emph{lot} of thesis (at least one per month) and
you start reading 
...
presents a cure for cancer, you can make as many spelling mistakes as
you like, you can write your thesis on a napkin and the thesis can
...
\begin{answer}
  ...
  \item In a single-author paper (such as your thesis), the word “we”
    always refers to “the reader and I” (that is, “you and me”). Thus,
